    ...
    $.each(arreglo, function (index, producto) {
        $('#listaProductos').append(`
            <li class="list-group-item d-flex justify-content-between align-items-start">
                <div class="row g-0">
                    <div class="col-md-4">
                        <img src="./img/productos/${producto.imagen}" class="img-fluid rounded-start" alt="...">
                    </div>
                    <div class="col-md-8">
                        <div class="card-body">
                            <h5 class="card-title h1">${producto.pronombre}</h5>
                            <p class="card-text h2">${producto.prodetalle}</p>
                            <p class="card-text"><strong class="text-muted h3">$ ${producto.precio}</strong></p>
                        </div>
                    </div>
                </div>
                <h5><span class="badge bg-warning rounded-pill">Cantidad: ${producto.procantstock}</span></h5>
            </li>
        `);
    });
