...
function enviarMail($data)
{
    ...
    try {
        ...
        $mail->SMTPAuth = true;
        $mail->Username = 'zapatillas.phpmailer@gmail.com';
        $mail->Password = 'owppffjxztvxjntn';
        $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;
        $mail->Port = 465;


        $mail->setFrom('example@hotmail.com', 'Administrador');
                    ...
                    <div class='containerFull'>
                        ...
                        <div class='containerText'><h1 class='h1'>Pedido recibido!</h1>
                            ...
                            <div class='containerRedes'>
                                ...
                                <a
                                    href='http://localhost/Gomeria/Vista/listaCompras.php'
                    ...
                    <div class='containerFull'>
                        ...
                        <div class='containerText'><h1 class='h1'>Pedido aceptado!</h1>
                            ...
                            <div class='containerRedes'>
                                ...
                                <a  href='http://localhost/Gomeria/Vista/listaCompras.php' target='_blank'><button class='hvr-overline-from-center' >Click aquí!</button></a>
                            </div>
                        </div>
                    </body>
                </html>";
                    ...
                    <div class='containerFull'>
                        ...
                        <div class='containerText'><h1 class='h1'>Pedido enviado!</h1>
                            ...
                            <div class='containerRedes'>
                                ...
                                <a
                                    href='http://localhost/Gomeria/Vista/productos.php'
                                    target='_blank'><button class='hvr-overline-from-center'>Click
                                        aquí!</button></a>
                            </div>
                        </div>
                ...
                <body class='bodyCont'>
                    <div class='containerFull'>
                        ...
                        <div class='containerText'><h1 class='h1'>Pedido cancelado</h1>
                            ...
                            <div class='containerRedes'>
                                <h3 class='h3 subtitleRedes'>Volvé a comprar con nosotros!</h3>
                                <a  href='http://localhost/Gomeria/Vista/productos.php' target='_blank'><button class='hvr-overline-from-center' >Click aquí!</button></a>
                            </div>
                        </div>
                    </body>
                </html>";
