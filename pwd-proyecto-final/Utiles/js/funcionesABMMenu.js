...
function armarTabla(arreglo) {
  ...
  $.each(arreglo, function (index, menu) {
    if (menu.medescripcion === "#") {
      if (menu.hijos) {
        boton = '<a href="#"><button class="agregarHijo btn btn-info mx-2" data-bs-toggle="modal" data-bs-target="#agregar-modal-hijo">Agregar Hijos</button></a>';
      } else {
        boton = '<a href="#"><button class="agregarHijo btn btn-info mx-2" data-bs-toggle="modal" data-bs-target="#agregar-modal-hijo">Agregar Hijos</button></a><a href="#"><button class="convertirSimple btn btn-warning mx-2">Convertir en Enlace Simple</button></a><a href="#"><button class="eliminar btn btn-danger mx-2">Eliminar</button></a>';
      }
    } else {
      boton = '<a href="#"><button class="convertirPadre btn btn-success mx-2">Convertir en Padre</button></a><button class="eliminar btn btn-danger mx-2">Eliminar</button></a>'
    }
