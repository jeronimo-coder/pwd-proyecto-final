                ...
                <table class="table table-hover caption-top align-middle text-center" id="tablaRoles">
                    ...
                    <tbody class="table-group-divider">
                        <tr class="table-active">
                            ...
                            <td><a href="#" class="agregar"><button class="btn btn-success"><i class="fa-solid fa-folder-plus"></i></button></a></td>
                        </tr>
                        <?php
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a href="#" class="editar"><button class="btn btn-info"><i class="fa-solid fa-file-pen mx-2"></i></button></a>
                                    <a href="#" class="eliminar"><button class="btn btn-danger"><i class="fa-solid fa-trash mx-2"></i></button></a>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
            ...
            <div class="position-fixed top-50 start-50 translate-middle">
                <div class="container-fluid p-4 mt-5 border border-2 rounded-2 bg-light bg-light shadow-lg p-3 mb-5 d-none" style="width: 350px;" id='editarRol'>
                    ...
                    <form action="./accion/editarRol.php" method="post" name="editarR" id="editarR" accept-charset="utf-8" class="mb-3">
                        ...
                        <button class="btn btn-info" type="submit" name="boton_enviar" id="boton_enviar">Modificar</button>
                        <button class="btn btn-danger mx-2" name="cancelar" type="button" id="cancelar">Cancelar</button>
                    </form>
                </div>
            </div>
        </div>
