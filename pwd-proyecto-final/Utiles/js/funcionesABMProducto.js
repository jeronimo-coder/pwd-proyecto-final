...
function armarTabla(arreglo) {
    ...
    $.each(arreglo, function (index, producto) {
        if (producto.deshabilitado == null || producto.deshabilitado == "1999-01-01 00:00:00") {
            var boton = '<a href="#" class="deshabilitar me-2"><button class="btn btn-dark"><i class="fa-solid fa-ban"></i>Deshabilitar</button></a>';
        } else {
            var boton = '<a href="#" class="habilitar me-2"><button class="btn btn-success"><i class="fa-solid fa-square-check"></i></button></a>';
        }
    ...
    <tr>
        ...
        <td><img src="./img/productos/${producto.imagen}" class="rounded float-start" width="150" height="150"></td>
        <td>${producto.deshabilitado}</td>
        <td>
            <button type="button" class="editarButton btn btn-info mx-2" data-bs-toggle="modal" data-bs-target="#editar-modal-producto">
                <i class="bi-pencil"></i>
                Agregar
            </button>
            ${boton}
