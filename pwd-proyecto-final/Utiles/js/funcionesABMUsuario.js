...
function armarTabla(arreglo) {
    ...
    $.each(arreglo, function (index, usuario) {
        ...
        if (usuario.usdeshabilitado == null || usuario.usdeshabilitado == "0000-00-00 00:00:00") {
            var boton = '<a href="#" class="deshabilitar me-2"><button class="btn btn-dark"><i class="fa-solid fa-ban me-2"></i>Deshabilitar</button></a>';
        } else {
            var boton = '<a href="#" class="habilitar me-2"><button class="btn btn-success"><i class="fa-solid fa-square-check me-2"></i>Habilitar</button></a>';
        }

        $('#tablaUsuarios > tbody:last-child').append(`
    <tr>
        ...
        <td>${usuario.roles}</td>
        <td>
            <a href="#" class="eliminarRol">
                <button class="btn btn-danger">
                    <i class="me-2"></i>Quitar Rol
                </button>
            </a>
            <a href="#" class="agregarRol">
                <button class="btn btn-info">
                    <i class="me-2"></i>Agregar Rol
                </button>
            </a>
            ${boton}
        </td>
